...
```json
{"ts":"<UTC ISO 8601>","skill":"setup-pre-commit","version":"<from CONFIG.yaml>","prompt":"<user's original request>","outcome":<1-5>,"note":"<brief note if not 4>","source":"llm","schema_version":1}
```
