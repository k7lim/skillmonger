...
# Source Attribution — improve-codebase-architecture
...
| File | Zone |
|---|---|
| `INTERFACE-DESIGN.md` | adapted |
| `SKILL.md` | adapted |
| `DEEPENING.md` | verbatim |
| `HTML-REPORT.md` | verbatim |
...
```bash
scripts/check-upstream.sh improve-codebase-architecture
```
