...
# Source Attribution — to-issues

| | |
|---|---|
| Repository | https://github.com/mattpocock/skills |
| Upstream path | `skills/engineering/to-tickets` |
| Previous upstream path | `skills/engineering/to-issues` |
| Pinned ref | `v1.2.3` |
...
Upstream renamed and substantially rewrote this skill (`skills/engineering/to-issues` -> `skills/engineering/to-tickets`). Our version diverged first: it was adapted to beads rather than GitHub issues. Treat upstream as a source of ideas to port deliberately, not a diff to apply.
...
```bash
scripts/check-upstream.sh to-issues
```
