...
GATE 2 DEFERRED: produces decision tickets on a GitHub-shaped tracker. In this repo that means beads — `bd create --type decision`, epics via `--parent`. Translate before writing anything to a tracker.
