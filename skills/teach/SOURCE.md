...
|---|---|
| `SKILL.md` | adapted |
| `GLOSSARY-FORMAT.md` | verbatim |
| `LEARNING-RECORD-FORMAT.md` | verbatim |
| `MISSION-FORMAT.md` | verbatim |
| `RESOURCES-FORMAT.md` | verbatim |
...
```bash
scripts/check-upstream.sh teach
```
